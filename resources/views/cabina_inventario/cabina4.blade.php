                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn"  href="{{ route('inventario.create_vista4') }}" style="background: {{$configuracion->color_boton_close}}; color: #ffff;margin-right: 3rem;">
                                        ...
                                        <tbody>
                                            @foreach ($cabinas as $cabina)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-success" href="{{ route('inventario.edit_cabina4',$cabina->id) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
