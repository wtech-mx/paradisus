                                                        ...
                                                        <div class="tab-pane" id="nav-{{$registro->num_sesion}}">
                                                            <div class="row mt-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12"><strong>Talla</strong></div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-12"><strong>Abdomen</strong></div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label for="fecha">Antes</label>
                                                                    ...
                                                                    <div class="col-12"><strong>Cintura</strong></div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label for="fecha">Antes</label>
                                                                    ...
                                                                    <div class="col-12"><strong>Cadera</strong></div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label for="fecha">Antes</label>
