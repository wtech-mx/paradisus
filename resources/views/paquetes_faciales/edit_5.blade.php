                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Antes</label>
                                                                    <input id="celulitis_a" name="celulitis_a" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Despues</label>
                                                                    <input id="celulitis_d" name="celulitis_d" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <strong>Textura</strong>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Antes</label>
                                                                    <input id="textura_a" name="textura_a" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Despues</label>
                                                                    <input id="textura_d" name="textura_d" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <strong>Gluteos</strong>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Antes</label>
                                                                    <input id="gluteos_a" name="gluteos_a" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="fecha">Despues</label>
                                                                    <input id="gluteos_d" name="gluteos_d" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <span>Nota</span>
