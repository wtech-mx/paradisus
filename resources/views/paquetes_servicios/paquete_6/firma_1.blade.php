...
<div class="icon-bar">
    ...
    <a href="#nav-siete" class="facebook">
        7
    </a>
    <a href="#nav-ocho" class="facebook">
        8
    </a>
    <a href="#nav-nueve" class="facebook">
        9
    </a>
    <a href="#nav-diez" class="facebook">
        10
    </a>
  </div>
...
<main class="main-content main-content-bg mt-0">
                    ...
                    <div class="col-md-12">
                        ...
                        <label for="example-text-input" class="form-control-label">Paquete:</label>
                            <div class="input-group mb-4">
                                ...
                                <input class="form-control" type="text" value="Piernas de 10 Anticelulítico & Reafirmante" disabled>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-6 mb-3">
                                                 ...
                                                 <div class="col-12">
                                                    ...
                                                    @if ($paquete3->firma9 == NULL)
                                                        <form method="POST" action="{{ route('paquetes_firma.store_firma', $paquete3->id_paquete) }}" enctype="multipart/form-data" role="form">
                                                            @csrf
                                                            <div id="sig9"></div>
                                                                        <br/><br/>
  ...
  <script type="text/javascript">
      ...
      var sig10 = $('#sig10').signature({syncField: '#signed10', syncFormat: 'PNG'});
