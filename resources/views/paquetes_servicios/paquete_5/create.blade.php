            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <h3 class="mb-3">Crear Paquete: Glúteos Definido & Perfectos</h3>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <input  id="num_paquete" name="num_paquete" type="text" value="5" style="display: none">
                                    <input  id="id_servicio" name="id_servicio" type="text" value="155" style="display: none">
