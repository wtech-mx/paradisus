            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <h3 class="mb-3">Editar Paquete: Drenante & Linfático</h3>
                ...
                <div class="card-body" >
                    ...
                    href="https://wa.me/52{{$paquete->Client->phone}}?text=Hola%20{{$paquete->Client->name}}%20{{$paquete->Client->last_name}},%20te%20enviamos%20tu%20nota%20el%20d%C3%ADa:%20{{ $paquete->fecha1 }}%20Esperamos%20que%20la%20hayas%20pasado%20incre%C3%ADble,%20vuelve%20pronto.%0D%0ADa+click+en+el+siguente+enlace%0D%0A%0D%0{{ route('firma_paquete_cuatro.firma_edit_cuatro', $paquete->id) }}}"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div id="sig-pago4"></div>
                                                <br/><br/>
                                                <button id="clear-pago4" class="btn btn-danger btn-sm">Repetir</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if ($paquete->firma == NULL)
                                            <div id="sig-ini4"></div>
                                            <br/><br/>
                                            <button id="clear-ini4" class="btn btn-danger btn-sm">Repetir</button>
...
<script type="text/javascript">
    var sig_ini4 = $('#sig-ini4').signature({syncField: '#signed_ini4', syncFormat: 'PNG'});

    $('#clear-ini4').click(function (e) {
        e.preventDefault();
        sig_ini4.signature('clear');
        $("#signed_ini4").val('');
    });

    var sig2 = $('#sig-pago4').signature({syncField: '#signed_pago4', syncFormat: 'PNG'});

    $('#clear-pago4').click(function (e) {
        e.preventDefault();
