          ...
          <div class="col-12 col-md-9">
            <div class="card border-0 mb-0">
              ...
              <div class="card-body px-lg-3 pt-0">
                ...
                <form method="POST" action="{{ route('brow_consentimiento.user', $ConcentimientoFacial->id) }}" enctype="multipart/form-data" role="form">
                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Brow Lamination" id="renales" name="renales">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Brow Lamination
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Henna Brows" id="digestivas" name="digestivas">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Henna Brows
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Tu Ceja Perfecta" id="circulatorias" name="circulatorias">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Tu Ceja Perfecta
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Depilación c/cera & Diseño de Ceja" id="diabetes" name="diabetes">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Depilación c/cera & Diseño de Ceja
                                                </label>
                                            </div>
                                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="Si" id="pregunta15" name="pregunta15">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Si
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="No" id="pregunta15" name="pregunta15">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            No
                                        </label>
                                    </div>
