                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input  id="pagoInput" name="pagoInput" type="number" class="form-control" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input  id="dineroRecibidoInput" name="dineroRecibidoInput" type="number" class="form-control" step="any">
                                </div>
                            </div>
