...
<html lang="en">
  <head>
    ...
    <title>Corporales | Encuesta de satisfaccion</title>
              ...
              <div class="col-10 custom_col p-3">
                ...
                <div class="card card_custom" style="">
                  ...
                  <div class="card-header" style="border: solid 0px;background:transparent;">
                    ...
                    <p class="text-center">
                        <label class="form-control-label" style="font-size: 35px;">Corporales</label>
                    </p>
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <form method="POST" action="{{ route('create.faciales') }}" id="miFormulario" enctype="multipart/form-data" role="form" style="text-align: center;">
                            @csrf
                            <input class="form-control" id="tipo" name="tipo" type="text" value="Corporal" style="display: none">
